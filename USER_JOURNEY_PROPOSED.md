# Creative Discovery Workshop - User Journey (Proposed State)

**Document Version:** 2.0
**Last Updated:** January 4, 2026
**Purpose:** Documents the proposed user experience improvements and changes
...
**Total Time Estimate:** Calculated based on total scheduled meeting time, user-defined.
...
**Visual Elements:**
- Large hero section with "Creative Discovery Workshop"
...
- Timeline bar showing time remaining and graduations for each step remaining, spaced according to recommended time for each step.
...
6. Are we focusing on the tangibles they can see and touch, or something intangible like awareness, attitude shift, or action?
...
**Timer Behavior:**
- filling timeline with MM:SS format label
- toast popup when <1 minute time budget remains for current exercise
- toast popup turns red when expired
...
- After 4th question answered, "advance to phase 3" appears
...
## End of Proposed Documentation

**Next Steps:** Compare USER_JOURNEY_CURRENT.md to find changes.
